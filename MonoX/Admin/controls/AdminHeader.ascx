        ...
        <nav class="top-bar">
            ...
            <ul class="left">
                ...
                <li class="has-dropdown <%= GetSubMenuSelectedCssClass(MonoSoftware.MonoX.Paths.MonoX.Admin.NewsQuickPost_aspx) %>">
                    <asp:HyperLink ID="lnkNews" runat="server" NavigateUrl='javascript:void(0);' ><%= AdminResources.AdminHeader_lnkNews %></asp:HyperLink>
                    <ul class="dropdown">
                        <li>
                ...
                <li class="has-dropdown <%= GetSubMenuSelectedCssClass(MonoSoftware.MonoX.Paths.MonoX.Admin.BlogManager_aspx) %>">
                    <asp:HyperLink ID="lnkBlog" runat="server" NavigateUrl='javascript:void(0);' ><%= AdminResources.AdminHeader_lnkBlog %></asp:HyperLink>
                    <ul class="dropdown">
                ...
                <li class="has-dropdown <%= GetSubMenuSelectedCssClass(MonoSoftware.MonoX.Paths.MonoX.Admin.SnGroupCategoryManager_aspx) %>">
                    <asp:HyperLink ID="lnkSocial" runat="server" NavigateUrl='javascript:void(0);' Enabled='<%# MonoSoftware.MonoX.Utilities.PageUtility.CanViewAdminPage(MonoSoftware.MonoX.Paths.MonoX.Admin.SnGroupManager_aspx) %>'><%= AdminResources.AdminHeader_lnkGroups%></asp:HyperLink>
                    <ul class="dropdown">
                        <li>
...
<div class="sub-nav">
    ...
    <ul>
        ...
        <li>
            <asp:HyperLink ID="HyperLink2" runat="server" CssClass="icon-book" NavigateUrl='http://monox.mono-software.com/Downloads/#MonoX' Target="_blank" Text='<%$ Code: AdminResources.Default_lnkMonoXDocumentation %>'></asp:HyperLink></li>
        <li>
            <asp:HyperLink ID="HyperLink3" runat="server" CssClass="icon-med" NavigateUrl='http://monox.mono-software.com/Downloads/#MonoX' Target="_blank" Text='<%$ Code: AdminResources.Default_lnkMonoXApi %>'></asp:HyperLink></li>
        <li>
