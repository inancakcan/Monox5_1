<%@ Page Language="C#" 
AutoEventWireup="True" CodeBehind="BlogPosts.aspx.cs" 
Inherits="MonoSoftware.MonoX.Admin.BlogPosts" 
        ...
        <div class="admin-row">
            ...
            <div class="admin-content">
                ...
                <div class="spacer-sml">
                    <h4 class="analytics-title"><%= AdminResources.Analytics_BlogPosts_Title %></h4>
                    <div class="graph">
                ...
                <div class="admin-quarter-width spacer-med">
                    <div class="box-data-display">
                        ...
                        <span class="box-data-label"><%= AdminResources.Analytics_BlogPosts_Total %></span>
                    </div>
                </div>
            </div>
