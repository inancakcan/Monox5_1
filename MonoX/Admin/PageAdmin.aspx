...
<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/MonoX/MasterPages/AdminDefault.master"
 CodeBehind="PageAdmin.aspx.cs" Inherits="MonoSoftware.MonoX.Admin.PageAdmin" Theme="DefaultAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" Runat="Server">
        ...
        function TreeMenuClick(sender, eventArgs)
        {
            ...
            switch (menuItem.get_value()) {
                ...
                case "NewExternalPage":
                    OpenRadWindow("PageManagerExternalPage.aspx", 700, 300, "NewExternalPage", menuItem.get_text());
                    break;
                case "SetUrl":
                ...
                case "Roles":
                    ...
                    if (treeNode != null)
                    {
                        OpenRadWindow("PageManagerNavigationRoles.aspx?nodeId=" + treeNode.get_value(), 700, 550, "Roles", menuItem.get_text());
                    }
                    break;
            }
        }
        ...
        function GridMenuClick(sender, eventArgs)
        {
            ...
            switch (menuItem.get_value()) {
                ...
                case "Delete":
                    ...
                    break;
                case "PageProperties":
                    OpenRadWindow("FileManagerPropertiesDialog.aspx?pageId=" + selectedRow.getDataKeyValue("Id"), 700, 550, "PageProperties", eventArgs.get_item().get_text());
                    break;
                case "ManageWebParts":
                    OpenRadWindow("PageManagerPartAdmin.aspx?pageId=" + selectedRow.getDataKeyValue("Id"), 700, 550, "ManageWebParts", eventArgs.get_item().get_text());
                    break; 
                case "ManagePageTemplates":
                    OpenRadWindow("PageManagerPageTemplates.aspx", 700, 550, "ManagePageTemplates", eventArgs.get_item().get_text());
                    break; 
                case "NewPage":
                    OpenRadWindow("PageManagerPropertiesDialog.aspx", 700, 550, "NewPage", eventArgs.get_item().get_text());
                    break;
                case "RegisterPage":
                    OpenRadWindow("PageManagerRegisterPage.aspx", 700, 550, "RegisterPage", eventArgs.get_item().get_text());
                    break;
                case "TestPages":
                    OpenRadWindow("PageManagerPageCrawl.aspx", 700, 550, "PageCrawl", eventArgs.get_item().get_text());
                    break; 
    ...
    <MonoXControls:MonoXWindowManager Skin="MetroTouch" ID="rwmSingleton" runat="server" OnClientClose="OnClientClose"></MonoXControls:MonoXWindowManager>
    <div class="page-admin">
            <div class="pageManagerRoot">
                <telerik:RadSplitter ID="RadSplitterBrowser" runat="server" VisibleDuringInit="false" ResizeWithBrowserWindow="true" BorderColor="Gray" 
                    ...
                    Skin="MetroTouch"
                    >
                    <telerik:RadPane ID="RadPaneTreeView" runat="server" Height="100%" Width="30%" Skin="MetroTouch">
                        <div class="leftPaneHeader">
                            <div>
                                <asp:Label ID="lblPages" runat="server" Text='<%$ Code: AdminResources.PageAdmin_lblPages %>'></asp:Label>
                            </div>
                            <div>
                                <asp:HyperLink NavigateUrl="javascript:void(0)" CssClass="searchPagesAction" Text='<%$ Code: AdminResources.PageAdmin_lnkSearch %>' runat="server" ID="lnkSearch"></asp:HyperLink>
                            </div>
                        </div>
                        <div class="CssForm searchModule">
                            ...
                            <p>
                                <asp:CheckBox ID="chkAdmin" runat="server" CausesValidation="false" Text='<%$ Code: AdminResources.PageAdmin_chkAdmin %>' OnCheckedChanged="chkAdmin_CheckedChanged" AutoPostBack="true" />
                            </p>
                          <p>
                        ...
                        <telerik:RadTreeView ID="tvPages" runat="server" EnableDragAndDrop="true" EnableDragAndDropBetweenNodes="true" OnClientContextMenuShowing="TreeMenuShowing" OnClientContextMenuItemClicking="TreeMenuClick" OnContextMenuItemClick="mnuMain_ItemClick"
                            ...
                            >
                            <ContextMenus>
                                <telerik:RadTreeViewContextMenu ID="treeContextMenu" ExpandAnimation-Type="None" CollapseAnimation-Type="None" runat="server" Skin="MetroTouch">
                                    <Items>
                        ...
                        <telerik:RadGrid ID="gridPages" runat="server" AllowSorting="true" OnPreRender="gridPages_PreRender" PagerStyle-Font-Bold="true" PagerStyle-Font-Size="12px" PagerStyle-Mode="NextPrevAndNumeric"
                            ...
                            <MasterTableView ClientDataKeyNames="Id" Width="100%"  DataKeyNames="Id" TableLayout="Fixed" >
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="LocalizedTitle" ItemStyle-Wrap="false"
                                    ...
                                    <telerik:GridBoundColumn DataField="AspnetUsers.UserName" ItemStyle-Wrap="false"
