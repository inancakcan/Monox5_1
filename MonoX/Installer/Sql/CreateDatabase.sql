...
CREATE TABLE [dbo].[AuditInfo] (
	...
	[DateCreated] [datetime] NOT NULL CONSTRAINT [DF_AuditInfo_DateCreated] DEFAULT (getutcdate()),
	[DateUpdated] [datetime] NOT NULL CONSTRAINT [DF_AuditInfo_DateUpdated] DEFAULT (getutcdate()),
...
CREATE TABLE [dbo].[ChatMessage] (
	...
	[Deleted] [bit] NOT NULL CONSTRAINT [DF_ChatMessage_Deleted] DEFAULT ((0)));
GO

--Table dbo.ChatParticipant
...
CREATE TABLE [dbo].[ChatParticipant] (
	...
	[IsInFocus] [bit] NOT NULL CONSTRAINT [DF_ChatParticipant_IsInFocus] DEFAULT ((0)),
	[IsOpened] [bit] NOT NULL CONSTRAINT [DF_ChatParticipant_Opened] DEFAULT ((0)));
GO
...
CREATE TABLE [dbo].[ChatSession] (
	[Id] [uniqueidentifier] NOT NULL,
	[DateCreated] [datetime] NOT NULL,
	[IsGroup] [bit] NOT NULL CONSTRAINT [DF_ChatSession_IsGroup] DEFAULT ((0)));
GO
...
--Indexes of table dbo.AuditInfo
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[AuditInfo] ADD CONSTRAINT [PK_AuditInfo] PRIMARY KEY CLUSTERED ([Id]) 
GO
...
--Indexes of table dbo.ChatMessage
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[ChatMessage] ADD CONSTRAINT [PK_ChatMessage] PRIMARY KEY CLUSTERED ([Id]) 
GO

--Indexes of table dbo.ChatParticipant
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[ChatParticipant] ADD CONSTRAINT [PK_ChatParticipant] PRIMARY KEY CLUSTERED ([Id]) 
GO

--Indexes of table dbo.ChatSession
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER TABLE [dbo].[ChatSession] ADD CONSTRAINT [PK_ChatSession] PRIMARY KEY CLUSTERED ([Id]) 
GO
...
GO
ALTER TABLE [dbo].[AuditInfo] WITH CHECK ADD CONSTRAINT [FK_AuditInfo_aspnet_Users] 
	FOREIGN KEY ([UserId]) REFERENCES [dbo].[aspnet_Users] ([UserId])
	ON UPDATE NO ACTION
	ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[ChatMessage] WITH CHECK ADD CONSTRAINT [FK_ChatMessage_ChatParticipant] 
	FOREIGN KEY ([ChatParticipantId]) REFERENCES [dbo].[ChatParticipant] ([Id])
	ON UPDATE NO ACTION
	ON DELETE NO ACTION
GO
ALTER TABLE [dbo].[ChatMessage] CHECK CONSTRAINT [FK_ChatMessage_ChatParticipant]
GO
ALTER TABLE [dbo].[ChatParticipant] WITH CHECK ADD CONSTRAINT [FK_ChatParticipant_aspnet_Users] 
	FOREIGN KEY ([UserId]) REFERENCES [dbo].[aspnet_Users] ([UserId])
	ON UPDATE NO ACTION
	ON DELETE NO ACTION
GO
...
GO
ALTER TABLE [dbo].[ChatParticipant] WITH CHECK ADD CONSTRAINT [FK_ChatParticipant_ChatSession] 
	FOREIGN KEY ([ChatSessionId]) REFERENCES [dbo].[ChatSession] ([Id])
	ON UPDATE NO ACTION
	ON DELETE NO ACTION
GO
