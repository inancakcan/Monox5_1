...
$.extend({
    ...
    registerToggleMultiElementVisibility: function (clickElementClass, elementToToggleClass, containerElementClass, elementToFocusClass, onBeforeToggle) {
        $("." + containerElementClass).find("." + elementToToggleClass).hide();
        $.toggleMultiElementVisibility(clickElementClass, elementToToggleClass, containerElementClass, elementToFocusClass, onBeforeToggle);
        var prm = Sys.WebForms.PageRequestManager.getInstance();
        if (prm != null) {
    ...
    toggleMultiElementVisibility: function (clickElementClass, elementToToggleClass, containerElementClass, elementToFocusClass, onBeforeToggle) {
        $("." + clickElementClass).unbind('click');
        $("." + clickElementClass).bind('click', function () {
            ...
            if (elementToFocusClass != null)
                $(this).parents("." + containerElementClass).find("." + elementToToggleClass).find("." + elementToFocusClass + ":first").focus();
