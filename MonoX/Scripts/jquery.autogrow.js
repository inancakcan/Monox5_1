...
*
* autor: john kuindji
* modified my Mono to eliminate the IE problems
*/
...
(function($) {
    ...
    growfield.prototype = {
        ...
        getDummyHeight: function() {
            ...
            // must do this two times, as it seems that IE is too slow ehn calculating new height after the new text is inserted
            if ($.browser.msie) this.dummy[0].style.height = this.dummy[0].scrollHeight + 'px';
