    ...
    <div class="message-details">
        ...
        <asp:ListView ID="lvPosts" runat="server">
            ...
            <div class="message-holder" >
                ...
                <div class="content">
                    <div class="date"><asp:Literal ID="lblDate" runat="server" Text='<%# DependencyInjectionFactory.Resolve<MonoSoftware.MonoX.Repositories.IUserRepository>().ConvertTimeFromUtcToUserLocalTime(MonoSoftware.MonoX.Utilities.SecurityUtility.GetUserId(), ((MonoSoftware.MonoX.DAL.EntityClasses.SnMessageEntity)Container.DataItem).DateCreated) %>'></asp:Literal></div>
        ...
        <div class="message-form">
            <dl>
                <dd class="editor-height">
                    ...
                    <asp:RequiredFieldValidator ID="valMessage" runat="server" ControlToValidate="txtMessage"  SetFocusOnError="true" CssClass="validator" Display="Dynamic" />
                ...
                <asp:Panel runat="server" ID="pnlUpload" Style="border: none;">
                    <dd class="silverlight-file-holder boxed-content">
                        <div class="edit-title">
